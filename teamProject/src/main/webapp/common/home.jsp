...
<body>
	...
	<div class="top-content">
	    <div class="container">
	        <div class="row">
	        	<h3 class="main-title textsize28 text-left wow fadeInDown" data-wow-delay="0.1s">제주도 여행의 모든것,</h3>
	...
	<div class="event-box container-xxl py-5">
		<div class="carousel-container-pa container my-5 py-5">
			<div class="carousel-container">
			  <h4 class=" font-black event-title text-left" style="font-size: 20px;">운영자가 추천하는 제주도의 행사를 확인해보세요!</h4>
			  ...
			  <div class="carousel-captions">
				  <p class=" event-captions carousel-captionx visible">${requestScope.eventList[0].startdate} ~ ${requestScope.eventList[0].enddate}<br>${requestScope.eventList[0].ename}</p>
				  <p class=" event-captions carousel-captionx hidden">${requestScope.eventList[1].startdate} ~ ${requestScope.eventList[1].enddate}<br>${requestScope.eventList[1].ename}</p>
				  <p class=" event-captions carousel-captionx hidden">${requestScope.eventList[2].startdate} ~ ${requestScope.eventList[2].enddate}<br>${requestScope.eventList[2].ename}</p>
				</div>
			</div>
		</div>
		<!-- <h6 class=" text-center" >(최신게시물은 사진이 없어 추후 최신순으로 변경예정. 현재 가장 오래된 순)</h6> -->
	</div>
	<!-- 이달의 행사 -->
	...
	<div class="foodtour-box container-xxl py-5">
		<div class="container my-5 py-5">
			<div class="row align-items-center g-5">
				...
				<h5 class=" font-gray text-left" style="font-size: 18px;">회원님들이 가장 많이 추천한 게시물 입니다.</h5>
				<hr class="subtitle-hr">
				<%-- 맛집 --%>
				<div class="col-sm-6 foodtour-bean"> 
					<div>
						<a href="<%=notWithFormTag%>fdMain">
							<p class="TheJamsil400 foodtour-subtitle text-left" style="font-size: 30px;">맛집</p>
						</a>
						<c:forEach var="bean" items="${requestScope.foodList}">
							<div class="col-sm-6 foodtour-bean text-left">
								...
								<p class="TheJamsil400 foodtour-subcon text-left" >${bean.title}</p>
								<p class="TheJamsil100 foodtour-subcon text-left" >${bean.category}</p>
							</div>
						</c:forEach>
						<%-- <a class=" moreview text-left" >맛집 더보기</a> --%>
					</div>
				</div>
				...
				<div class="col-sm-6 foodtour-bean"> 
					<div>
						<a href="<%=notWithFormTag%>trMain">
							<p class="TheJamsil400 foodtour-subtitle text-left" style="font-size: 30px;">관광지</p>
						</a>
						<c:forEach var="bean" items="${requestScope.tourList}">
							<div class="col-sm-6 foodtour-bean text-left">
								...
								<p class="TheJamsil400 foodtour-subcon text-left" >${bean.ttitle}</p>
								<p class="TheJamsil100 foodtour-subcon text-left" >${bean.tcategory}</p>
							</div>
						</c:forEach>
					</div>     	
				</div>
				...
				<div class="col-sm-8 free-bean"> 
					<div>
						<a href="<%=notWithFormTag%>frMain">
							<p class="TheJamsil400 foodtour-subtitle text-left" style="font-size: 30px;">자유게시판 베스트</p>
						</a>	
						<hr class="subtitle-hr">
					</div>
					<div>	
				...
				<div class="col-sm-4">
					<div class="memberBox">
						<div style="margin-bottom: 30px;">
							<h3 class="textsize25 text-center" style="white-space: nowrap; font-size: 30px;">
								<img class="thumbnail-content" src="<%=appName%>/assets/img/crown.png" alt="crown.png" style="width: 30px;">
								회원랭킹
								<img class="thumbnail-content" src="<%=appName%>/assets/img/crown.png" alt="crown.png" style="width: 30px;">
							</h3>
							<h4 class="text-center" style="white-space: nowrap; font-size: 20px;">
								top 10
							</h4>
						</div>
						<div>
								...
								<tbody>
									...
									<tr class="non-border text-left">
			                           	<td colspan="1" class="non-border col-sm-1">
			                           		...
			                           		<c:if test="${bean.rank > 3}">
			                           			<span class=" badge badge-secondary" style="font-size:: 14px;">${bean.rank}</span>
			                           		</c:if>
			                            </td>
	  ...
	  <div class="container">
	  	<div class="row">
	  		<div class="col-sm-12 footer-copyright">
	             	<i class="fa fa-love"></i><a class="" style="font-size: 30px; color: dark;" href="https://www.jeju.go.kr/index.htm">제주도청으로</a>
	             </div>
	         </div>
	 	 </div>
	 </footer>
